...
export function createCiv7NarrativeChoiceTelemetryRecord(
  ...
  return createCiv7OperationProofTelemetryRecord({
    ...
    validation_post: input.result.sent
      ...
      : undefined,
    postcondition: narrativeChoicePostcondition(input.result, input.proofBoundary),
...
function narrativeChoicePostcondition(
  ...
  if (!narrativeChoicePostconditionConfirmed(result.postcondition.classification)) {
    return {
      ...
      outcome: narrativeChoiceOutcome(result.postcondition.classification),
      noRepeatAfterUnverified: true,
      confidence: "unverified",
    };
  }
...
function narrativeChoicePostconditionConfirmed(
...
function narrativeChoiceOutcome(
  classification: Civ7NarrativeChoicePostconditionClassification,
