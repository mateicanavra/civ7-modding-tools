...
const TOPICS: ReadonlyArray<Topic> = [
  ...
  },
  {
    ...
    purpose: 'Review and evolve the game play command grammar without breaking proven live-play commands.',
    ...
    loadWhen: 'when command names, topic shortcuts, aliases, response tiers, or preview/check/send phases are being redesigned',
    boundary: 'add wrappers and aliases first; do not remove existing commands until play-agent callers and tests have migrated',
  },
  {
