...
export default class GamePlayFrontSummary extends Command {
  ...
  static flags = {
    ...
    "to-x": Flags.integer({
      description:
        "Optional intended target/front x coordinate. Defaults to the nearest target candidate city when available.",
      dependsOn: ["to-y"],
    }),
    "to-y": Flags.integer({
      description:
        "Optional intended target/front y coordinate. Defaults to the nearest target candidate city when available.",
      dependsOn: ["to-x"],
    }),
    destination: Flags.string({
      description:
        "Optional intended target/front as x,y. Defaults to the nearest target candidate city when available.",
    }),
