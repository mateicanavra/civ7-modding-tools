...
export const civ7MutationReadinessMiddleware = civ7ControlOrpcImplementer.middleware(
  async ({ context, errors, next, path, procedure }) => {
    ...
    if (!status.playable && !civ7ControllerMutationReadinessBypass(context, procedureKey)) {
