...
export type Civ7WorldCurrentResult = Static<typeof Civ7WorldCurrentResultSchema>;

const Civ7WorldCurrentInputStandardSchema = toStandardSchema(Civ7WorldCurrentInputSchema);
const Civ7WorldCurrentResultStandardSchema = toStandardSchema(Civ7WorldCurrentResultSchema);
...
export type Civ7WorldPlotReadResult = Static<typeof Civ7WorldPlotReadResultSchema>;
...
export type Civ7WorldGridReadResult = Static<typeof Civ7WorldGridReadResultSchema>;

const Civ7WorldPlotReadInputStandardSchema = toStandardSchema(Civ7WorldPlotReadInputSchema);
const Civ7WorldPlotReadResultStandardSchema = toStandardSchema(Civ7WorldPlotReadResultSchema);
