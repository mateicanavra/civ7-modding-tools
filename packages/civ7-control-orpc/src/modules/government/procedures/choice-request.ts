...
export const governmentChoiceRequestProcedure = civ7ControlOrpcMutationProcedure(
...
export const governmentCelebrationChoiceRequestProcedure = civ7ControlOrpcMutationProcedure(
