...
export const liveCiv7ControlOrpcDirectControlFacade: Civ7ControlOrpcDirectControlFacade = {
  requestCiv7ProductionChoice: async (input, options) =>
    requestCiv7ProductionChoice(input, options) as Promise<Civ7ControlOrpcProductionChoiceResult>,
  requestCiv7NotificationDismissal: async (input, options) =>
    requestCiv7NotificationDismissal(
      input,
      options
    ) as Promise<Civ7ControlOrpcNotificationDismissalResult>,
  requestCiv7AdvisorWarningViewed: async (input, options) =>
    requestCiv7AdvisorWarningViewed(input, options),
  requestCiv7NarrativeChoice: async (input, options) => requestCiv7NarrativeChoice(input, options),
  ...
  requestCiv7CultureTarget: async (input, options) => requestCiv7CultureTarget(input, options),
  ...
  requestCiv7TraditionChange: async (input, options) => requestCiv7TraditionChange(input, options),
  requestCiv7TraditionReviewCloseout: async (input, options) =>
    requestCiv7TraditionReviewCloseout(input, options),
  requestCiv7TownFocusChange: async (input, options) => requestCiv7TownFocusChange(input, options),
  ...
  requestCiv7AssignWorkerPlacement: async (input, options) =>
    requestCiv7PlayerOperation(
      ...
      options
    ) as Promise<Civ7ControlOrpcPopulationPlacementRuntimeResult>,
  ...
  requestCiv7UnitTargetAction: async (input, options) =>
    requestCiv7UnitTargetAction(input, options) as Promise<Civ7ControlOrpcUnitTargetActionResult>,
  requestCiv7UnitCommand: async (input, options) =>
    requestCiv7UnitCommand(input, options) as Promise<Civ7ControlOrpcUnitCommandRuntimeResult>,
  requestCiv7TurnComplete: async (options) => requestCiv7TurnComplete(options),
  getCiv7PlayableStatus: async (options) =>
    getCiv7PlayableStatus(options) as Promise<Civ7ControlOrpcPlayableStatusResult>,
  getCiv7PlayNotificationView: async (options) =>
    getCiv7PlayNotificationView(options) as Promise<Civ7ControlOrpcPlayNotificationViewResult>,
  getCiv7ProgressDashboard: async (input, options) => getCiv7ProgressDashboard(input, options),
  getCiv7TraditionsView: async (input, options) => getCiv7TraditionsView(input, options),
  getCiv7BattlefieldScan: async (input, options) =>
    getCiv7BattlefieldScan(input, options) as Promise<Civ7ControlOrpcBattlefieldScanResult>,
  getCiv7DestinationAnalysis: async (input, options) =>
    getCiv7DestinationAnalysis(input, options) as Promise<Civ7ControlOrpcDestinationAnalysisResult>,
  getCiv7PlotSnapshot: async (input, options) => getCiv7PlotSnapshot(input, options),
  getCiv7MapGrid: async (input, options) => getCiv7MapGrid(input, options),
  getCiv7ReadyUnitView: async (input, options) =>
    getCiv7ReadyUnitView(input, options) as Promise<Civ7ControlOrpcReadyUnitViewResult>,
  getCiv7ReadyCityView: async (input, options) =>
    getCiv7ReadyCityView(input, options) as Promise<Civ7ControlOrpcReadyCityViewResult>,
  getCiv7SettlementRecommendations: async (input, options) =>
    getCiv7SettlementRecommendations(
      input,
      options
    ) as Promise<Civ7ControlOrpcSettlementRecommendationsResult>,
  getCiv7TargetCandidates: async (input, options) =>
    getCiv7TargetCandidates(input, options) as Promise<Civ7ControlOrpcTargetCandidatesResult>,
  getCiv7TurnCompletionStatus: async (options) =>
    getCiv7TurnCompletionStatus(options) as Promise<Civ7ControlOrpcTurnCompletionStatusResult>,
  getCiv7VisibilitySummary: async (input, options) => getCiv7VisibilitySummary(input, options),
  readCiv7DisplayQueue: async (options) => readCiv7DisplayQueue(options),
  closeCiv7Displays: async (input, options) => closeCiv7Displays(input, options),
  suspendCiv7DisplayQueue: async (options) => suspendCiv7DisplayQueue(options),
  resumeCiv7DisplayQueue: async (options) => resumeCiv7DisplayQueue(options),
  applyCiv7ExploreGrant: async (input, options) => applyCiv7ExploreGrant(input, options),
  releaseCiv7ExploreGrant: async (input, options) => releaseCiv7ExploreGrant(input, options),
  focusCiv7Camera: async (input, options) => focusCiv7CameraOnPlot(input, options),
  enterCiv7CleanFrame: async (input, options) => enterCiv7CleanFrame(input, options),
  exitCiv7CleanFrame: async (options) => exitCiv7CleanFrame(options),
  captureCiv7WindowShot: async (input) => captureCiv7WindowShot(input),
};
