...
describe("@civ7/map-policy", () => {
  ...
  it("records the build-elevation policy provenance", () => {
    expect(CIV7_BUILD_ELEVATION_BOUNDARY_POLICY_V0.source).toContain(
      "Base/modules/base-standard/maps/elevation-terrain-generator.js"
    );
  });
});
