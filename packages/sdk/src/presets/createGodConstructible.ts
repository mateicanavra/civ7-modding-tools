 ...
 */
export function createGodConstructible(
  actionGroupBundle: ActionGroupBundle,
  constructibleType: string = "BUILDING_GOD"
) {
  return new ConstructibleBuilder({
    ...
    constructibleValidDistricts: [DISTRICT.URBAN, DISTRICT.CITY_CENTER, DISTRICT.RURAL],
