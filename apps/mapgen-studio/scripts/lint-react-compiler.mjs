 ...
 *
 * Usage (from anywhere):
 *   node apps/mapgen-studio/scripts/lint-react-compiler.mjs            # lint studio src
 *   node apps/mapgen-studio/scripts/lint-react-compiler.mjs <paths...> # lint specific paths
 *   node apps/mapgen-studio/scripts/lint-react-compiler.mjs --strict   # exit 1 on errors
 */
...
// Resolve relative to this script so the default target + cwd are invariant to
// where the command is invoked from (root, the app dir, an nx task, …).
