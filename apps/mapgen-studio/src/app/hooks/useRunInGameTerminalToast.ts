 ...
 * `lastRunInGameToastRef` (keyed by `requestId`) is the shared dedupe guard. This
 * hook stamps pushed terminal events and handler completions; adoption stamps
 * retained daemon-current terminal operations before they render. Without both paths,
