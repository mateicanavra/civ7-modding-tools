...
describe("D2 engine Effect corpus", () => {
  it("keeps app-hosted Studio runtime surfaces represented in the runtime ledger", async () => {
    ...
    const requiredRuntimeTokens: CorpusToken[] = [
      ...
      "materializeRunInGameConfig",
      "restoreRepoConfig",
      "regenerateSwooperMapArtifacts",
      "assertRepoMapEnvelope",
      "restartCiv7ProcessViaSteam",
      "waitForCiv7ShellReadiness",
      "CIV7_PROCESS_LAUNCH_SHELL_TIMEOUT_MS",
      "CIV7_PROCESS_INTRO_DISMISS_CATEGORIES",
      "attemptCiv7IntroDisplayDismissal",
      "getCiv7PlayableStatus",
      "closeCiv7Displays",
      "directControlProbeValue",
      "snapshotFile",
      "readFreshLogText",
