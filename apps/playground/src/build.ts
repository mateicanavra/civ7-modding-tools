...
const unit = new UnitBuilder({
  ...
  localizations: [{ name: "Custom scout", description: "test description" }],
});
...
const constructible = new ConstructibleBuilder({
  ...
  constructibleYieldChanges: [{ yieldType: YIELD.GOLD, yieldChange: 20 }],
...
civilization.bind([unit, constructible, constructible2, uniqueQuarter, progressionTree]);
