/**
 * Generated from the Swooper catalog config mountain-rivers-patch.config.json.
  ...
  "config": {
    ...
    "morphology-features": {
      "knobs": {
        ...
        "volcanism": "high",
        "mountainRanges": {
          "tectonicActivity": 1.35,
          "rangeSystemSpacingTiles": 23,
          "rangeSystemLengthTiles": 19,
          "provinceRadiusTiles": 3,
          "ridgeWidthTiles": 3,
          "foothillExtentTiles": 3,
          "interiorHighlandExpression": 0.85,
          "terrainTextureFractalMix": 0.85,
          "erosionMaturity": 0.36,
          "tectonicSignalSensitivity": 1.05
        }
      },
      "islands": {
        "islands": {
      ...
      "assign-starts": {
        "starts": {
          ...
          "config": {
            ...
            "minExpansionLandTiles": 30,
            "islandClusterRadiusTiles": 8,
            "minIslandClusterLandTiles": 30,
            "maxIslandStartCoastDistance": 8,
            "spacingFloorTiles": 6,
            "desiredSpacingTiles": 10,
            "resourceSupportRadiusTiles": 4,
            "resourceSupportWeight": 0.6,
            "fertilityWeight": 1.3,
...
export default createMap({
  ...
  envelopeHash: "fa559d5698cffda3abb415db824f8f4da7a1a36e41f4547a98f1a9063cd40a73",
