...
} from "@swooper/swooper-physics/standard/parity";
...
const usage = `Usage:
  nx run swooper-physics-mod:verify:final-surface-parity -- --request-id <id>
  nx run swooper-physics-mod:verify:final-surface-parity -- --diagnostics-id <id>
  nx run swooper-physics-mod:verify:final-surface-parity -- --evidence-file <diagnostics.json>
