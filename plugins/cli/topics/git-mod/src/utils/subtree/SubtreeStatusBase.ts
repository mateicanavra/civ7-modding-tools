import { findRemoteNameForSlug, getRemotePushConfig, logRemotePushConfig } from "@civ7/plugin-git";
import { Args, Command, Flags } from "@oclif/core";

export default abstract class SubtreeStatusBase extends Command {
