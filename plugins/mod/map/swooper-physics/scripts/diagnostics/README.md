...
# inspect / diff
nx run swooper-physics:diag:list -- dist/visualization/probe-baseline/<runId>
nx run swooper-physics:diag:diff -- dist/visualization/probe-baseline/<runId> dist/visualization/probe-platecount6/<runId>
```
...
- Product thresholds and cohort expectations belong to the Standard recipe metric study bank and
  run through `nx run swooper-physics:metrics:report`, not through a second dump analyzer.
