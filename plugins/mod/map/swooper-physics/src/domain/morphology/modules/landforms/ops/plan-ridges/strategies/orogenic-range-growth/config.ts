  ...
  config: Type.Object(
    {
      ...
      hillMaxFraction: Type.Number({
        description:
          "Controls hard cap on hill terrain coverage as a fraction of land tiles (0..1).",
        default: 0.18,
        minimum: 0,
        maximum: 1,
      }),
      ...
      mountainCollisionStressWeight: Type.Number({
        description:
          "Controls stress contribution to mountain terrain scoring in collision regimes.",
        default: 0.5,
        minimum: 0,
        maximum: 10,
      }),
      mountainCollisionUpliftWeight: Type.Number({
        description:
          "Controls uplift contribution to mountain terrain scoring in collision regimes.",
        default: 0.5,
        minimum: 0,
        maximum: 10,
      }),
