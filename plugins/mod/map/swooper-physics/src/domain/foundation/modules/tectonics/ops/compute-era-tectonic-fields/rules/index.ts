...
/**
 * Resolves authored influence distance and decay into the bounded emission radii used by event fields.
 * Centralizing this derivation keeps every tectonic signal on the same spatial falloff policy.
 */
...
/**
 * Emits one era's event records into aligned tectonic intensity fields over the Foundation mesh.
