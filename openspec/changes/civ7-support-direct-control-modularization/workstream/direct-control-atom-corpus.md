...
stabilizer, and default approval/Tuner-execution/parser dependency wiring while public facade exports stay in `index.ts`. This completes the
unit-target source/wrapper relocation plus facade dependency injection pruning; broader telemetry, AI ingestion, semantic CLI projection, Effect/oRPC procedure-core work, and Task 2.9.4 matrix-row acceptance remain pending.
