...
stabilizer while public facade exports and type re-exports stay in `index.ts`.
It also owns the unit-target input, candidate, and result public types. This
completes the unit-target source/wrapper/type relocation; broader generic operation and
