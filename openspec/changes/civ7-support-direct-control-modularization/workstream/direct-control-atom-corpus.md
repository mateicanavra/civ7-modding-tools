...
`executeCiv7Command` rejection, mutation approval/validator/postcondition/
...
stabilizer, and default approval/Tuner-execution/parser dependency wiring while
the public facade re-exports the read plan and approved request wrappers
...
App UI snapshot read, App UI command execution, approval, validation/bounds,
...
This preserves approval gates, bounded turn/player validation, explicit
