...
| Baseline logic is the largest hidden old-root coupling. | P1 | accepted | `design.md` now requires explicit baseline support file refs or a deliberate global id-based baseline contract; spec includes consumed-artifact requirements. |
