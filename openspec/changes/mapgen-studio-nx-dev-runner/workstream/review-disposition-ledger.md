...
| D11-PRE-02 | P2 | prework scout `019ec826-5de7-7993-ac06-03a419cf75c0` | Exact Nx config location and target names depend on accepted migrated baseline. | target-name ambiguity | accepted-repaired as packet gate | Specify normative semantics and preferred names; allow existing accepted target names only when proof records semantic equivalence. | `design.md` D2 and `prework-ledger.md` implementation prework. | No |
