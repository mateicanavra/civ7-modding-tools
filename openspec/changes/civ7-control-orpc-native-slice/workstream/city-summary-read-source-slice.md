...
Burn-down note: the public `city.summary.read` control-oRPC contract, router
leaf, handler, tagged error, direct-control facade context method, and focused
test were removed in the summary-wrapper burn-down slice. The direct-control
city summary atom remains the low-level read owner until a real
