...
| D7 Structural Enforcement Pipeline | `ruleSelectorFacts`, `ruleReportFacts`, `ruleExecutionFacts`, `ruleRoutingFacts`, `ruleBaselineFacts`, `ruleGritFacts`, `ruleGeneratedZoneFacts` | May design enforcement aggregation against named projections and D1 output families. | Blocked until D2 implementation provides live projections and D5/D6/D10 owner packets close their own source behavior. |
...
| D10 Protected Zone Authority | `ruleGeneratedZoneFacts` plus G-HOST declarations and D1 refusals | May design guard/refusal behavior against D2 generated-zone references. | Blocked until D2 implementation provides generated-zone projections and G-HOST accepts host-policy boundary. |
| D13 Scaffolding And Refusal Contracts | `ruleGovernanceFacts`, `ruleGeneratedZoneFacts`, scaffold relation metadata | May design generator/refusal scenarios against D2 registry references and D8/G-HOST decisions. | Blocked until D2/D8/G-HOST implementation facts exist. |
