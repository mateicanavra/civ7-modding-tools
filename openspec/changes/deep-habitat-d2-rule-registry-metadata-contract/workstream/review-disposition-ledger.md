...
| TypeScript state-space investigation: target TypeScript model was left to implementation. | P1 | accepted; repaired; final rereview closed | `design.md` chooses `RuleRegistryDocument`, closed `ownerTool` union, variant constraints, projections, and deletion of fallback states. |
