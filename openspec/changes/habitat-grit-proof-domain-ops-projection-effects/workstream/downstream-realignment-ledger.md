...
| --- | --- | --- |
| `docs/projects/habitat-harness/grit-pattern-corpus-ledger.md` | Replace pending repair-scan row with DOP native fixture and parser inventory evidence. | Updated in this row. |
...
| `openspec/changes/habitat-grit-proof-repair/workstream/command-proof-log.md` | Add `DOPE-NATIVE-FIXTURES-2026-06-15` and `DOPE-DOMAIN-OPS-INVENTORY-2026-06-15`. | Updated in this row. |
...
| `tools/habitat-harness/baselines/grit-domain-ops-projection-effects.json` | Explicit empty baseline already exists. | No patch; inherited baseline inventory/integrity proof cited. |
