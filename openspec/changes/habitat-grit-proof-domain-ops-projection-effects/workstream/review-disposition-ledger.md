# Review Disposition Ledger - Domain Ops Projection Effects
...
| --- | --- | --- | --- | --- |
| `DOPE-P2-DUPLICATE-FIXTURE-2026-06-15` | P2 | Local row-readiness review | Repaired before checkpoint: duplicate single `artifact:map.foo` sample was replaced with artifact/effect, literal-shape, false-positive, path-control, and parser-edge fixture classes. | `DOPE-NATIVE-FIXTURES-2026-06-15` |
