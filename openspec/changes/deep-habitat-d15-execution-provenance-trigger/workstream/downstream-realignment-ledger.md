...
| --- | --- | --- |
| Phase 2 packet suite | pending | Mark D15 as OpenSpec-packetized after review. |
| D0 compatibility matrix | pending | Confirm public surfaces touched by D15 are classified before implementation. |
...
| Later domino packets | pending | Update dependency assumptions if review changes D15 contract. |
