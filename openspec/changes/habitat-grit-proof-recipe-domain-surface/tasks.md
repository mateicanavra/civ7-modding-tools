...
- [ ] 2.3 Confirm current Grit predicate file classes and exact Habitat Grit
  adapter scan roots.
- [ ] 2.4 Confirm the retired recipe import lint/test invariant and retirement
  parity claim.
...
- [ ] 2.6 Confirm neighboring boundaries with `grit-domain-deep-import`,
...
- [ ] 3.3 Add or record proof for allowed domain-root, exact `/ops`, and exact
  `/config.js` imports.
...
- [ ] 3.6 Record fixture class counts and parser-edge proof ids in the
...
- [ ] 4.5 Run current-tree inventory for `@mapgen/domain/<domain>/<tail>`
  imports and re-exports inside and outside effective scope.
- [ ] 4.6 Record live `/ops`, `/config.js`, root, `/ops/<tail>`, `ops-by-id`,
...
- [ ] 8.1 `bun run openspec -- validate habitat-grit-proof-recipe-domain-surface --strict`
- [ ] 8.2 native fixture proof
- [ ] 8.3 parser-edge import/export proof
- [ ] 8.4 exact allowed-surface proof
- [ ] 8.5 substring-gap disposition
- [ ] 8.6 namespace and side-effect import disposition
- [ ] 8.7 recipe-local test-path classification
...
- [ ] 8.12 current-tree import inventory
- [ ] 8.13 injected recipe proof
- [ ] 8.14 outside-scope path-control proof
- [ ] 8.15 explicit baseline proof
- [ ] 8.16 baseline owner linkage
- [ ] 8.17 aggregate proof matrix aligned
- [ ] 8.18 recovery claim ledger aligned
- [ ] 8.19 active-packet language guardrail scan
- [ ] 8.20 `git diff --check`
- [ ] 8.21 `bun run openspec:validate`
- [ ] 8.22 commit via Graphite with a clean worktree
