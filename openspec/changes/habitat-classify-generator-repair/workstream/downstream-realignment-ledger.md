...
| `docs/projects/habitat-harness/recovery-claim-ledger.md` | H8 and generator rows need to distinguish repaired classify target/scope truth and generator refusal truth from still-open scratch discovery and migration work. | patched for current classify target, scope, and generator support/refusal behavior | Keep open until scratch Nx discovery, target-matrix proof, and migration proof-boundary work land. | partially realigned |
