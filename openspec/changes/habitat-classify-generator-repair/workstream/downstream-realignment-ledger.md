...
| `docs/projects/habitat-harness/recovery-claim-ledger.md` | H8 and generator rows need to distinguish repaired classify target/scope truth and generator support/refusal/discovery truth from still-open migration work. | patched for current classify target, scope, generator support/refusal, scratch discovery, and target-matrix behavior | Keep open until migration proof-boundary work and final packet closure land. | partially realigned |
