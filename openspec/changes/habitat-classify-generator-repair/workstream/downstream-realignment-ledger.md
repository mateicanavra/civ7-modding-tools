...
| `docs/projects/habitat-harness/recovery-claim-ledger.md` | H8 and target rows need to distinguish repaired classify target/scope truth from still-open generator and migration work. | patched for current classify target and scope behavior | Keep open until generator root/refusal and migration proof-boundary work land. | partially realigned |
