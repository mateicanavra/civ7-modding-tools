...
- [x] 1.3 Update hook service tests for default and Habitat artifact-only paths.
- [x] 1.4 Update harness docs for the artifact-only pre-push behavior.
...
- [x] 2.5 Graph probe for rule artifact changes uses Habitat structural targets instead of generic `check`.
