...
changes Habitat authority data. Because source-check rule authority files are owned by
...
- Use Habitat structural targets for Habitat authority-only changes.
