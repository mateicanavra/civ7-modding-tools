...
| P1 | `.habitat` authored artifacts were outside actual inventory scope despite being in the requested guardrail scope. | Repaired by adding `.habitat` authored artifact inventory for 50 rule records, 33 check patterns, 3 apply patterns, and 0 executable-code files. |
...
- `guardrail-owner-map.md` assigns owner/artifact paths for every recurring
  violation class;
