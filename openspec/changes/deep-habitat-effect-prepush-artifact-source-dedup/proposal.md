...
Habitat authority routing should use the existing Nx target graph more precisely:
...
- Make Habitat authority path planning registry-aware.
...
- Keep broad `habitat:check` only for unclassified Habitat authority data.
