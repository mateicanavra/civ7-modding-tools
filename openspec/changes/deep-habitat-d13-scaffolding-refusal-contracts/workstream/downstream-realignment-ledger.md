...
| --- | --- | --- |
| Phase 2 packet suite | pending | Mark D13 as OpenSpec-packetized after review. |
| D0 compatibility matrix | pending | Confirm public surfaces touched by D13 are classified before implementation. |
...
| Later domino packets | pending | Update dependency assumptions if review changes D13 contract. |
