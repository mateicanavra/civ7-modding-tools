...
| `src/lib/hook-runtime/**` | 11 | `src/domains/local-feedback/**`, `src/providers/{git,biome,grit,nx}/**`, `src/resources/write-set.ts` | split | Optional runtime dependency bag is replaced by Effect requirements and fake layers. |
