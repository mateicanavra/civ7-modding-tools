...
- source declarations: static import declarations, side-effect imports, dynamic
  import expressions, named re-exports, and export-star declarations;
...
mods, string literals, or recipe-looking source lookalikes such as
`@mapgen/recipes-extra` and `recipes-extra`.

## Corpus And False-Positive Classes

- Positive fixture classes: value import, type-only import, side-effect import,
  package-style recipe alias import, recipe alias import, dynamic import, named
  re-export, and export-star.
...
The row does not prove raw direct Grit acquisition, source remediation, apply
safety, classify/generator behavior, broader domain-refactor closure, or
