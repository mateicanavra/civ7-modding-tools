...
| `docs/projects/habitat-harness/workstream-record.md` | Train-closed and H6 closure rows could be read as current proof despite live repair packets. | patched in Nx packet realignment | Keep downgraded/historical state unless a repair packet closes with fresh proof. | patched |
