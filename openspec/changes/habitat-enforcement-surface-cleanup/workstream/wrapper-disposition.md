...
| `arch-test-intelligence-bridge-bundle-runtime-imports` | `nx run mod-civ7-intelligence-bridge:test:architecture-bundle-runtime-imports --outputStyle=static` | Exits 0 when generated Intelligence Bridge bundle output is current; stale or missing generated bundle output remains a direct test failure. | Habitat projects this architecture test through the coarse wrapper. Generated-output freshness is proved by the package-owned Nx target dependency chain and generated-zone drift gate, not by wrapper parser behavior. | Retain while built Intelligence Bridge bundle output freshness owns runtime-import semantics. |
