...
Operational ledger: `.habitat/workstreams/rule-remediation-layer1-action-matrix.json`
...
2. `.habitat/dominoes.md`.
3. `.habitat/AUTHORITY-ONTOLOGY.md`.
4. Active `.habitat/frames/*.md`.

Operational selection authority:

1. `.habitat/workstreams/rule-remediation-layer1-action-matrix.json`.
...
`.habitat/frames/POST-DEPENDENCY-TAG-POSITION-FRAME.md`. That frame treated
