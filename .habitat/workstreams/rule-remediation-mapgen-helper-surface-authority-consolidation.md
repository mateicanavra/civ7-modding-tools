...
- `.habitat/frames/RULE-REMEDIATION-WORKSTREAM-FRAME.md`
- `.habitat/frames/RULE-DECISION-PACKET-FRAME.md`
- `.habitat/workstreams/product-authority-framing/MAPGEN-PRODUCT-AUTHORITY-FRAME.md`
...
`.habitat/workstreams/rule-remediation-mapgen-helper-surface-authority-consolidation.md`
