...
| Operational ledger | `.habitat/workstreams/rule-remediation-layer1-action-matrix.json` | Canonical operational source for Layer 1 rows, packet queue, blockers, and action decisions |
