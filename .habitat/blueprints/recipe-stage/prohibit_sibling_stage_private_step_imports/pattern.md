...
```typescript
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/world/assembly/index.ts
...
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/world/terrain/steps/shape-surface/step.ts
export const ShapeSurfaceStep = {};

// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/world/assembly/steps/assemble/step.ts
import { ShapeSurfaceStep } from "../../../terrain/steps/shape-surface/step.js";
...
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/world/assembly/viz.ts
...
// @filename: plugins/mod/map/alternate-mod/src/recipes/alternate-recipe/stages/output/index.ts
...
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/world/terrain/steps/shape-surface/config.ts
export const config = {};

// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/world/terrain/steps/shape-surface/types.ts
...
```typescript
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/world/terrain/index.ts
...
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/terrain/index.ts
