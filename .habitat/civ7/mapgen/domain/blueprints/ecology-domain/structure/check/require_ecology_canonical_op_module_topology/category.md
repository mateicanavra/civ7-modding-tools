...
Evidence: The structure check forbids ecology op modules missing canonical direct children. Ecology is the canonical exemplar for decomposed op module topology; schema and JSDoc quality remain outside structure-check.
