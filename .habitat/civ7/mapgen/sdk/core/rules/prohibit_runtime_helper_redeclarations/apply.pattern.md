...
```typescript
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/hydrology/climate/steps/demo/step.ts
...
```typescript
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/hydrology/climate/steps/demo/helpers/range.ts
import { createStrategy } from "@swooper/mapgen-core/authoring";
...
```typescript
// @filename: plugins/mod/map/example-mod/src/domain/morphology/modules/terrain/ops/demo/strategies/balanced/index.ts
import { createStrategy } from "@swooper/mapgen-core/authoring";
...
```typescript
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/morphology/features/steps/demo/config.ts
import { createStrategy } from "@swooper/mapgen-core/authoring";
...
```typescript
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/morphology/features/steps/demo/step.test.ts
import { createStrategy } from "@swooper/mapgen-core/authoring";
...
```typescript
// @filename: plugins/mod/map/example-mod/src/recipes/sample-recipe/stages/morphology/features/steps/demo/__tests__/helper.ts
import { createStrategy } from "@swooper/mapgen-core/authoring";
