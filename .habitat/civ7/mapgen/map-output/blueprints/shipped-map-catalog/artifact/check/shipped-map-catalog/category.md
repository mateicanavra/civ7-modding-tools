...
Authority path: `.habitat/civ7/mapgen/map-output/blueprints/shipped-map-catalog/artifact/check/shipped-map-catalog`

Files:
- `shipped-map-catalog.baseline.json`
- `shipped-map-catalog.check.ts`
- `shipped-map-catalog.rule.json`
