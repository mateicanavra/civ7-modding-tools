...
| Domain model config/primitive decomposition | Content is a reusable domain schema fragment, enum, type, invariant, defaults object, or config contract that stage and operation surfaces compose. | `<domain>/model/config/<part>.config.ts` |
