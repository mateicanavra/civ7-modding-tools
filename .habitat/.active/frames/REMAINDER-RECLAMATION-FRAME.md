...
- `.habitat/.active/frames/AUTHORITY-REMAINDER-SLICE-FRAME.md` for contextual remainder
  meaning and physical sorting discipline.
- `.habitat/.active/frames/BLUEPRINT-KIND-GATHERING-FRAME.md` for the contrasting case
  where a missing constructible kind must be affirmed before gathering.
- `.habitat/.active/frames/NICHE-LANE-SHAPING-FRAME.md` for the contrasting case where
...
1. Reground in `.habitat/.active/dominoes/README.md`, `.habitat/AUTHORITY-TREE-SHAPE.md`,
   `.habitat/AUTHORITY-ONTOLOGY.md`, `.habitat/.active/frames/AUTHORITY-REMAINDER-SLICE-FRAME.md`,
...
15. Record a disposition receipt in the matching `.habitat/.active/dominoes/items/`
    file or the active slice doc. The receipt must match the physical tree.
