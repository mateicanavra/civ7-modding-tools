...
Dry-run (default):
```sh
node .habitat/docs/projects/_self/fix/issue-link-fixer/issue-link-fixer.fix.mjs
```

Apply changes:
```sh
node .habitat/docs/projects/_self/fix/issue-link-fixer/issue-link-fixer.fix.mjs --write
```

Different project root:
```sh
node .habitat/docs/projects/_self/fix/issue-link-fixer/issue-link-fixer.fix.mjs --project docs/projects/engine-refactor-v1 --write
```
