...
const schemaPaths = [
  ".habitat/habitat/blueprints/toolkit/contract/triage/generator-schemas/scaffold-project.schema.json",
  ".habitat/habitat/blueprints/toolkit/contract/triage/generator-schemas/scaffold-pattern.schema.json",
] as const;
