...
| --- | --- | --- | --- | --- |
| `boundary-taxonomy` | `habitat/toolkit/_self/triage/boundary-taxonomy/` | Boundary taxonomy validation command adapter. | `tools/habitat-harness/scripts/validate-boundary-taxonomy.ts` | Package script updated; rule metadata still needs explicit adapter registration. |
| `cli-smoke` | `habitat/toolkit/_self/triage/cli-smoke/` | Habitat CLI smoke validation command adapter. | `tools/habitat-harness/scripts/validate-cli-smoke.ts` | Package script updated; structural rule identity still undecided. |
...
| `service-module-shape` | `habitat/toolkit/_self/triage/service-module-shape/` | Service tree/file-kind validation command adapter. | `tools/habitat-harness/scripts/validate-service-module-shape.ts` | Package script and target routing updated; target state is a positive pattern allowlist. |
