...
const schemaPaths = [
  ".habitat/habitat/toolkit/blueprints/generator/generate_generator_schema_contracts/scaffold-project.schema.json",
  ".habitat/habitat/toolkit/blueprints/generator/generate_generator_schema_contracts/scaffold-pattern.schema.json",
] as const;
