...
or {
  contains r"\bhabitatServiceImplementer\b" where {
    $filename <: r".*tools/habitat/src/service/.*\.ts$"
  },
  `import $imports from $source` where {
    $filename <: r".*tools/habitat/src/service/modules/[^/]+/router\.ts$",
    ! $source <: r"^[\"']?\./module(?:\.js)?[\"']?$"
  },
  `import $imports from $source` where {
    $filename <: r".*tools/habitat/src/service/modules/[^/]+/router/.*\.router\.ts$",
    ! $source <: r"^[\"']?\.\./module(?:\.js)?[\"']?$"
  },
  `import { $imports } from $source` where {
    $filename <: r".*tools/habitat/src/service/modules/[^/]+/router\.ts$",
  ...
  `$target.effect(($args) => $body)` where {
    $filename <: r".*tools/habitat/src/service/modules/[^/]+/(?:router\.ts|router/.*\.router\.ts)$"
  },
  ...
  `const $name = $value` where {
    $filename <: r".*tools/habitat/src/service/router\.ts$",
    $name <: r".*RouterDefinition$"
  },
  `export const implementer = $value` where {
    $filename <: r".*tools/habitat/src/service/modules/[^/]+/module\.ts$"
  },
...
// @filename: tools/habitat/src/service/modules/check/router/run.router.ts
import { Effect } from "effect";
