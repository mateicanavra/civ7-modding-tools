...
import { type WriteProjectScaffoldDecision } from "@habitat/cli/generators/scaffold/model";
...
export function writeProjectScaffold(tree: Tree, decision: WriteProjectScaffoldDecision): void {
  ...
  writeJson(tree, path.posix.join(options.root, "project.json"), projectJson(options));
...
function projectJson(options: WriteProjectScaffoldDecision["request"]) {
  return {
