import { materializeDefaultHabitatCommand } from "@habitat/cli/resources/command/index";
import { defaultWorkspaceToolPolicies } from "@habitat/cli/resources/config/index";
