import { runSourceRulesEffect } from "@internal/habitat-harness/service/modules/check/source/index";
      ...
      diagnostics: [
        {
          ...
          path: "tools/habitat-harness/src/service/modules/check/source/rules/adapter-base-standard-import.mjs",
          message:
