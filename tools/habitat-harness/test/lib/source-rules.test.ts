import { runSourceRulesEffect } from "@internal/habitat-harness/service/model/check/source/index";
      ...
      diagnostics: [
        {
          ...
          path: "tools/habitat-harness/src/service/model/check/source/rules/adapter-base-standard-import.mjs",
          message:
