import { collapsedSourceScanRoots } from "@internal/habitat-harness/service/modules/check/model/policy/source/index";
  ...
  test("collapses nested scan roots before filesystem traversal", () => {
    expect(
      collapsedSourceScanRoots([
        ...
        "tools/habitat-harness/src/service/modules/check/model/policy/source",
