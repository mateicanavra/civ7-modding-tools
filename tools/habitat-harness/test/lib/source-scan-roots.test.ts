import { collapsedSourceScanRoots } from "@internal/habitat-harness/service/model/check/policy/source/index";
  ...
  test("collapses nested scan roots before filesystem traversal", () => {
    expect(
      collapsedSourceScanRoots([
        ...
        "tools/habitat-harness/src/service/model/check/policy/source",
