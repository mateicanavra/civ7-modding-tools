...
} from "../../core/domains/source-check/module-paths.ts";
import {
  habitatArtifactsProjectName,
  habitatArtifactsRoot,
  ruleRegistryRepoPath,
} from "../../substrate/lib/artifact-paths.ts";
import { repoRoot } from "../../substrate/lib/paths.ts";
import {
  loadRuleRegistryDocumentForNxPlugin,
  type NxRuleRegistryDocument,
  type NxRuleRegistryRecord,
} from "../../substrate/providers/nx/rule-registry-loader.ts";
import {
  WorkspaceGraphTargetNameOptionsSchema,
  WorkspaceGraphTargetNamesSchema,
} from "../../substrate/providers/nx/schema.ts";
import { workspaceGraphTargetNames } from "../../substrate/providers/nx/targets.ts";
...
const harnessInternalBoundaryProjects = [
  ...
  },
  {
    ...
    root: "tools/habitat-harness/src/core",
    tags: ["kind:tooling", "habitat:core"],
  },
  {
  ...
  {
    name: "@internal/habitat-harness-workspace",
    root: "tools/habitat-harness/src/workspace",
    tags: ["kind:tooling", "habitat:workspace"],
  },
  {
    name: "@internal/habitat-harness-host",
    root: "tools/habitat-harness/src/host",
    tags: ["kind:tooling", "habitat:host"],
  },
] as const;
