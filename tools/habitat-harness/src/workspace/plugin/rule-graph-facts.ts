import type { NxRuleRegistryRecord } from "@internal/habitat-harness/substrate/providers/nx/rule-registry-loader";
import type { WorkspaceGraphTargetNames } from "@internal/habitat-harness/substrate/providers/nx/schema";
