export const sourceCheckRuleRuntimeRepoPath =
  "tools/habitat-harness/src/service/model/source-check/policy/source/rule-runtime.policy.mjs";

export const sourceCheckRuleModulesRepoPath =
  "tools/habitat-harness/src/service/model/source-check/policy/source/rules";
