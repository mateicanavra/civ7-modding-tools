import { activeRuleGraphFacts } from "@internal/habitat-harness/service/modules/check/rules/registry/active-facts";
import {
  type CheckReport,
  type VerifyCheckSummary,
  verifyCheckSummary,
} from "@internal/habitat-harness/service/modules/check/structural/index";
import { verifyAffectedTargetNames } from "@internal/habitat-harness/service/modules/graph/validation-routing/index";
import {
