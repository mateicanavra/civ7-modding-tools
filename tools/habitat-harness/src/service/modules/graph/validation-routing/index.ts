import { habitatArtifactPathPlan } from "@internal/habitat-harness/service/modules/check/rules/registry/artifact-paths";
...
function isBoundaryTaxonomyToolingPath(filePath: string): boolean {
  return (
    ...
    filePath === "tools/habitat-harness/src/service/modules/graph/boundary-taxonomy.ts"
  );
}
