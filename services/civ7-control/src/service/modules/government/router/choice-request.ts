...
import type { Civ7ControlOrpcGovernmentChoiceResult } from "#civ7-control-service/model/ports/direct-control";
import type {
...
type GovernmentChoiceSource = "government.choice.request" | "government.celebration.choice.request";
type GovernmentChoiceResult = Civ7GovernmentChoiceResult | Civ7GovernmentCelebrationChoiceResult;
...
export const choiceRequest = {
  governmentChoiceRequestProcedure: civ7ControlOrpcMutationProcedure(module.choice.request).effect(
  ...
  governmentCelebrationChoiceRequestProcedure: civ7ControlOrpcMutationProcedure(
    module.celebration.choice.request
...
function governmentChoiceResult(
  ...
  const projection = civ7CloseoutMutationProjection({
    ...
    missing: {
      ...
      reason:
        "The government-domain choice result did not include explicit postcondition evidence.",
