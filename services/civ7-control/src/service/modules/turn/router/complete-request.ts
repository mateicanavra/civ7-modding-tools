...
import type { Civ7ControlOrpcTurnCompletionRequestResult } from "#civ7-control-service/model/ports/direct-control";
import type { Civ7TurnCompletionResult } from "../contract";
import { module } from "../module";
export const completeRequest = civ7ControlOrpcMutationProcedure(module.complete.request).effect(
