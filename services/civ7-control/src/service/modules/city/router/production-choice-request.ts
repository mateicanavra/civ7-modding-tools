...
import type { Civ7ControlOrpcProductionChoiceResult } from "#civ7-control-service/model/ports/direct-control";
import type { Civ7CityProductionChoiceResult } from "../contract";
import { module } from "../module";
export const productionChoiceRequest = civ7ControlOrpcMutationProcedure(
  module.production.choice.request
