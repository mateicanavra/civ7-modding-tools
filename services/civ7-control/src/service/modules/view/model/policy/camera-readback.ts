import type { Civ7ControlOrpcCameraFocusResult } from "#civ7-control-service/model/ports/direct-control";
import type { Civ7ViewCamera } from "#civ7-control-service/modules/view/contract/index";
