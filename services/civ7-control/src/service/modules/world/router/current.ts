...
import type { Civ7ControlOrpcPlayableStatusResult } from "#civ7-control-service/model/ports/direct-control";
import type { Civ7WorldCurrentResult } from "../contract";
import { module } from "../module";
export const current = module.current.effect(function* ({ context, errors }) {
