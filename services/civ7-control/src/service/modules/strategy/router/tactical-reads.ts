...
type MapLocation = Readonly<{
  x: number;
  y: number;
}>;
export const tacticalReads = {
  strategyBattlefieldScanProcedure: module.battlefieldScan.effect(function* ({
    context,
    errors,
    input,
  }) {
  ...
  strategyTargetCandidatesProcedure: module.targetCandidates.effect(function* ({
    context,
    errors,
    input,
  }) {
  ...
  strategyDestinationAnalysisProcedure: module.destinationAnalysis.effect(function* ({
    context,
    errors,
    input,
  }) {
