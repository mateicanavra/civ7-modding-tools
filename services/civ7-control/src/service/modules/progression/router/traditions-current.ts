...
import type { Civ7ControlOrpcTraditionsViewResult } from "#civ7-control-service/model/ports/direct-control";
import type { Civ7ProgressionTraditionsInput, Civ7ProgressionTraditionsResult } from "../contract";
import { module } from "../module";
export const traditionsCurrent = module.traditions.current.effect(function* ({
  context,
  errors,
  input,
}) {
