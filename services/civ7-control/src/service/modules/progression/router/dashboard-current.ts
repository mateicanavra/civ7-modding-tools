...
import type { Civ7ControlOrpcProgressDashboardResult } from "#civ7-control-service/model/ports/direct-control";
...
export const dashboardCurrent = module.dashboard.current.effect(function* ({
  context,
  errors,
  input,
}) {
