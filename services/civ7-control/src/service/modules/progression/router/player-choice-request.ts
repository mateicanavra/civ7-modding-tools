...
import type { Civ7ControlOrpcProgressionPlayerChoiceResult } from "#civ7-control-service/model/ports/direct-control";
import type {
...
export const playerChoiceRequest = {
  progressionAttributePurchaseRequestProcedure: civ7ControlOrpcMutationProcedure(
    module.attribute.purchase.request
  ...
  progressionAttributeReviewRequestProcedure: civ7ControlOrpcMutationProcedure(
    module.attribute.review.request
  ...
  progressionTraditionChangeRequestProcedure: civ7ControlOrpcMutationProcedure(
    module.tradition.change.request
  ).effect(function* ({ context, errors, input }) {
  ...
  progressionTraditionReviewRequestProcedure: civ7ControlOrpcMutationProcedure(
    module.tradition.review.request
  ).effect(function* ({ context, errors }) {
