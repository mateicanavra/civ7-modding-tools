...
export const choiceRequest = {
  progressionTechnologyChoiceRequestProcedure: civ7ControlOrpcMutationProcedure(
    module.technology.choice.request
  ...
  progressionCultureChoiceRequestProcedure: civ7ControlOrpcMutationProcedure(
    module.culture.choice.request
  ).effect(function* ({ context, errors, input }) {
    const kind = "culture";
