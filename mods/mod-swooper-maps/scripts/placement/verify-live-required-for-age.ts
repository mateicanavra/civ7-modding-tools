 ...
 *
 * Usage:
 *   nx run mod-swooper-maps:verify:operational -- --mode placement-live-required-for-age [--host h] [--port p] \
...
const usage = `Usage:
  nx run mod-swooper-maps:verify:operational -- --mode placement-live-required-for-age [options]
