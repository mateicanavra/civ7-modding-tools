 ...
 * @param width - Number of tile columns to populate.
 * @param height - Number of tile rows to populate.
 * @param latitudeByRow - Signed latitude in degrees for hemisphere-dependent deflection.
 * @param isWaterMask - Binary mask restricting every current pass to water cells.
 * @param windU - Quantized zonal wind component per tile.
 * @param windV - Quantized meridional wind component per tile.
 * @param options - Optional ocean geometry plus wind, gyre, coast, smoothing, and scaling controls.
 * @returns Quantized U/V current components consumed by ocean thermal advection.
 */
