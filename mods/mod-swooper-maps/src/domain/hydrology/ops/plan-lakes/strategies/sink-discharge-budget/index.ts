...
import SinkDischargeBudgetContract from "./contract.js";

/** High-discharge terminal sinks enter a bounded lake budget before controlled upstream expansion. */
const sinkDischargeBudgetStrategy = createStrategy(PlanLakesContract, SinkDischargeBudgetContract, {
  run: (input, config) => {
...
export default sinkDischargeBudgetStrategy;
