...
export default defineStrategy({
  ...
  config: Type.Object({
    ...
    minIslandClusterLandTiles: Type.Integer({
      ...
      maximum: 160,
      default: 18,
      description: "Minimum nearby land across small islands for an intentional archipelago start.",
    }),
    ...
    marginalLandRatio: Type.Number({
      ...
      maximum: 1,
      default: 0.5,
      description: "Fraction of minContiguousLandTiles a marginal-tier candidate must still reach.",
    }),
    marginalExpansionRatio: Type.Number({
      minimum: 0.1,
      maximum: 1,
      default: 0.65,
      description: "Fraction of minExpansionLandTiles a marginal-tier candidate must still reach.",
    }),
