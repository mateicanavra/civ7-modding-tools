...
export const VolcanoesConfigSchema = Type.Object({
  ...
  baseDensity: Type.Number({
    description: "Controls baseline volcanoes per land tile; higher density spawns more vents overall.",
    default: 1 / 170,
    minimum: 0,
    maximum: 1,
  }),
  ...
  randomJitter: Type.Number({
    description: "Controls additive map jitter per tile to break up deterministic volcano patterns.",
    default: 0.08,
    minimum: 0,
    maximum: 10,
  }),
