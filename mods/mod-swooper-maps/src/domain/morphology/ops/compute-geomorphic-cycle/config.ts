  ...
  diffusion: Type.Object(
    {
      ...
      talus: Type.Optional(
        Type.Number({
          description: "Controls optional talus threshold for terrain diffusion in normalized units.",
          default: 0.5,
          minimum: 0,
          maximum: 10,
        })
  ...
  deposition: Type.Object(
    {
      rate: Type.Number({
        description:
          "Controls sediment settling/transport rate for terrain deposition (0..1).",
        default: 0.1,
        minimum: 0,
        maximum: 1,
      }),
