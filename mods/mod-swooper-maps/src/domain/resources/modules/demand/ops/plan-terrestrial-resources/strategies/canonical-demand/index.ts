...
type TerrestrialSignalField = TerrestrialResourceSignals["primary" | "suppress"][number];
type TerrestrialSignalInput = Partial<Readonly<Record<TerrestrialSignalField, Uint8Array>>>;
