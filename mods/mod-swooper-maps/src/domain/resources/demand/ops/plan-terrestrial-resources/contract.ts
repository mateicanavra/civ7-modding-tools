...
import { ResourceSymbolSchema } from "../../../atoms/resource-family.schema.js";
import { ResourceExpectedCountRangeSchema } from "../../atoms/expected-count-range.schema.js";
...
const TerrestrialExpectationSchema = Type.Object(
  {
    ...
    status: Type.Union([Type.Literal("expected"), Type.Literal("blocked")]),
  ...
  },
  {
    ...
    description:
      "Terrestrial rows projected from the Earthlike expectation policy. The op consumes only the family-owned symbolic expectation fields.",
  }
);
