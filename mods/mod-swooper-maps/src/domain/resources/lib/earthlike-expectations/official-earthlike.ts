...
const DEFINITIONS = [
  ...
  def(
    ...
    "common local",
    { proxyRequirements: ["navigable-river mouth or floodplain proxy"] }
  ),
  def(
    "RESOURCE_COWRIE",
    "aquatic-coastal-navigable-river",
  ...
  def(
    ...
    "scarce coastal",
    { proxyRequirements: ["marine/coast lane despite cultivated group"] }
  ),
  def(
    "RESOURCE_INCENSE",
    "cultivated-plantation-medicinal",
  ...
  def(
    ...
    "regional abundant",
    { proxyRequirements: ["highland or relief proxy"] }
  ),
  def(
    "RESOURCE_COFFEE",
    "cultivated-plantation-medicinal",
  ...
  def(
    ...
    [16, 18, 20],
    ["wet forest/highland proxy up", "arid/desert zero"],
  ...
  def(
    "RESOURCE_TRUFFLES",
    "terrestrial-animal-forest-wild",
    "Moist woodland-edge or host-tree proxy on legal grass/plains/tundra wet soils.",
    [2, 3, 5],
    ["moist wooded edge/grass hills up", "arid/cold down"],
    "uncommon patchy",
    { proxyRequirements: ["woodland or host-tree proxy"] }
  ),
  def(
    "RESOURCE_RUBBER",
    "terrestrial-animal-forest-wild",
  ...
  def(
    ...
    "Hydrothermal, orogenic, and epithermal lodes; placer only with alluvial proxy.",
    [16, 18, 20],
    ["hills/orogen up", "alluvial up", "outside official hills zero"],
    "common anchored",
    { proxyRequirements: ["orogeny or alluvial proxy"] }
  ),
  def(
    "RESOURCE_GOLD_DISTANT_LANDS",
    "geological-mineral-gemstone-industrial",
  ...
  def(
    ...
    "common anchored",
    { proxyRequirements: ["orogeny proxy"] }
  ),
  def(
    "RESOURCE_SILVER_DISTANT_LANDS",
    "geological-mineral-gemstone-industrial",
  ...
  def(
    ...
    "moderate",
    { proxyRequirements: ["evaporite or sedimentary basin proxy"] }
  ),
  def(
    "RESOURCE_JADE",
    "geological-mineral-gemstone-industrial",
    ...
    "rare",
    { proxyRequirements: ["ultramafic or orogeny proxy"] }
  ),
  def(
    "RESOURCE_KAOLIN",
    "geological-mineral-gemstone-industrial",
    ...
    "common",
    { proxyRequirements: ["weathering or clay-flat proxy"] }
  ),
  def(
    "RESOURCE_MARBLE",
    "geological-mineral-gemstone-industrial",
    ...
    "moderate",
    { proxyRequirements: ["carbonate belt proxy"] }
  ),
  def(
    "RESOURCE_IRON",
    "geological-mineral-gemstone-industrial",
    ...
    "common strategic",
    { proxyRequirements: ["craton or orogeny proxy"] }
  ),
  def(
    "RESOURCE_SALT",
    "geological-mineral-gemstone-industrial",
    ...
    "moderate",
    { proxyRequirements: ["closed basin or evaporite proxy"] }
  ),
  def(
    "RESOURCE_LAPIS_LAZULI",
    "geological-mineral-gemstone-industrial",
  ...
  def(
    ...
    "moderate",
    { proxyRequirements: ["closed basin or arid soil proxy"] }
  ),
  def(
    "RESOURCE_COAL",
    "geological-mineral-gemstone-industrial",
    ...
    "common modern",
    { proxyRequirements: ["sedimentary basin proxy"] }
  ),
  def(
    "RESOURCE_NICKEL",
    "geological-mineral-gemstone-industrial",
  ...
  def(
    ...
    "moderate modern",
    { proxyRequirements: ["sedimentary basin or hydrocarbon basin proxy"] }
  ),
  def(
    "RESOURCE_CLAY",
    "geological-mineral-gemstone-industrial",
  ...
  def(
    ...
    "common industrial",
    { proxyRequirements: ["carbonate basin proxy"] }
  ),
  def(
    "RESOURCE_TIN",
    "geological-mineral-gemstone-industrial",
    ...
    { proxyRequirements: ["granite, orogeny, or placer proxy"] }
  ),
  def(
    "RESOURCE_PITCH",
    "geological-mineral-gemstone-industrial",
    ...
    "scarce",
    { proxyRequirements: ["hydrocarbon basin proxy"] }
  ),
  def(
    "RESOURCE_RUBIES",
    "geological-mineral-gemstone-industrial",
    "Corundum in marble/metamorphic belts; basalt-hosted or placer only with source proxy.",
    [3, 4, 6],
    ["marble/metamorphic up", "tropical collision belt up", "flat tropical requires source"],
    "rare luxury",
    { proxyRequirements: ["metamorphic, marble, or collision-belt proxy"] }
  ),
