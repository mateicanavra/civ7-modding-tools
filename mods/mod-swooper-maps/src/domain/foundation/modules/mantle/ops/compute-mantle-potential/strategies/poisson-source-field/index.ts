...
/**
 * Generates the smoothed plume and downwelling potential that drives the mantle branch.
 * Deterministic source placement makes the field reproducible for a given admitted seed and config.
 */
...
export default poissonSourceField;
