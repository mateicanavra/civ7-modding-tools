  ...
  run: (input, config) => {
    ...
    const size = validateGridSize({
      ...
      fields: [
        ...
        { label: "scoreGrasslandNavigable01", arr: input.scoreGrasslandNavigable01 as Float32Array },
    ...
    for (let i = 0; i < size; i++) {
      ...
      const candidates: FloodplainCandidate[] = [
        { feature: "FEATURE_DESERT_FLOODPLAIN_MINOR", score01: input.scoreDesertMinor01[i] ?? 0, tileIndex: i },
        {
          feature: "FEATURE_DESERT_FLOODPLAIN_NAVIGABLE",
          score01: input.scoreDesertNavigable01[i] ?? 0,
          tileIndex: i,
        },
        { feature: "FEATURE_GRASSLAND_FLOODPLAIN_MINOR", score01: input.scoreGrasslandMinor01[i] ?? 0, tileIndex: i },
        {
          feature: "FEATURE_GRASSLAND_FLOODPLAIN_NAVIGABLE",
          score01: input.scoreGrasslandNavigable01[i] ?? 0,
          tileIndex: i,
        },
        { feature: "FEATURE_PLAINS_FLOODPLAIN_MINOR", score01: input.scorePlainsMinor01[i] ?? 0, tileIndex: i },
        {
          feature: "FEATURE_PLAINS_FLOODPLAIN_NAVIGABLE",
          score01: input.scorePlainsNavigable01[i] ?? 0,
          tileIndex: i,
        },
        { feature: "FEATURE_TROPICAL_FLOODPLAIN_MINOR", score01: input.scoreTropicalMinor01[i] ?? 0, tileIndex: i },
        {
          feature: "FEATURE_TROPICAL_FLOODPLAIN_NAVIGABLE",
          score01: input.scoreTropicalNavigable01[i] ?? 0,
          tileIndex: i,
        },
        { feature: "FEATURE_TUNDRA_FLOODPLAIN_MINOR", score01: input.scoreTundraMinor01[i] ?? 0, tileIndex: i },
        {
