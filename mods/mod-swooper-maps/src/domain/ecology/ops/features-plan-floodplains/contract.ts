...
const floodplainScore = (description: string) =>
  TypedArraySchemas.f32({ description });
...
const PlanFloodplainsContract = defineOp({
  ...
  input: Type.Object({
    ...
    scoreDesertNavigable01: floodplainScore("Desert navigable floodplain suitability score per tile."),
    scoreGrasslandMinor01: floodplainScore("Grassland minor floodplain suitability score per tile."),
    scoreGrasslandNavigable01: floodplainScore("Grassland navigable floodplain suitability score per tile."),
    scorePlainsMinor01: floodplainScore("Plains minor floodplain suitability score per tile."),
    scorePlainsNavigable01: floodplainScore("Plains navigable floodplain suitability score per tile."),
    scoreTropicalMinor01: floodplainScore("Tropical minor floodplain suitability score per tile."),
    scoreTropicalNavigable01: floodplainScore("Tropical navigable floodplain suitability score per tile."),
    scoreTundraMinor01: floodplainScore("Tundra minor floodplain suitability score per tile."),
    scoreTundraNavigable01: floodplainScore("Tundra navigable floodplain suitability score per tile."),
