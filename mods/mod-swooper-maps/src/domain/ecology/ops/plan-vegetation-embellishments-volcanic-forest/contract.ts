...
const PlacementSchema = Type.Object({
  ...
  feature: Type.Literal("FEATURE_FOREST"),
});

const PlanVegetationEmbellishmentsVolcanicForestContract = defineOp({
  kind: "plan",
  id: "ecology/features/vegetation-embellishments/volcanic-forest",
  input: Type.Object({
...
export default PlanVegetationEmbellishmentsVolcanicForestContract;
