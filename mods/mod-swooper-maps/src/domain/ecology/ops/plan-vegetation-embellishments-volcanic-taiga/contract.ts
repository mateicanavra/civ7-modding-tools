...
const PlanVegetationEmbellishmentsVolcanicTaigaContract = defineOp({
  kind: "plan",
  id: "ecology/features/vegetation-embellishments/volcanic-taiga",
  input: Type.Object({
...
export default PlanVegetationEmbellishmentsVolcanicTaigaContract;
