...
import { hasAdjacentFeatureType } from "../rules/has-adjacent-feature-type.js";
import { isCoastalLand } from "../rules/is-coastal-land.js";
...
export const defaultStrategy = createStrategy(PlanWetPlacementWateringHoleContract, "default", {
  ...
  run: (input, config) => {
    ...
    const placements: { x: number; y: number; feature: "FEATURE_WATERING_HOLE" }[] = [];
