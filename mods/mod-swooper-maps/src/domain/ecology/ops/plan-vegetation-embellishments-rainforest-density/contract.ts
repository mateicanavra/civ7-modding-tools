...
const PlacementSchema = Type.Object({
  ...
  feature: Type.Literal("FEATURE_RAINFOREST"),
});

const PlanVegetationEmbellishmentsRainforestDensityContract = defineOp({
  kind: "plan",
  id: "ecology/features/vegetation-embellishments/rainforest-density",
  input: Type.Object({
...
export default PlanVegetationEmbellishmentsRainforestDensityContract;
