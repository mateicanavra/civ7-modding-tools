...
const PlanVegetationSagebrushSteppeContract = defineOp({
  kind: "plan",
  id: "ecology/features/plan-vegetation/sagebrush-steppe",
  input: Type.Object({
...
export default PlanVegetationSagebrushSteppeContract;
