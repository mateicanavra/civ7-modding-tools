...
const PlanVegetationSavannaWoodlandContract = defineOp({
  kind: "plan",
  id: "ecology/features/plan-vegetation/savanna-woodland",
  input: Type.Object({
...
export default PlanVegetationSavannaWoodlandContract;
