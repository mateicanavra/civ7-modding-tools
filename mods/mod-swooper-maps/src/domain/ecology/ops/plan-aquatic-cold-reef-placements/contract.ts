...
const PlanAquaticColdReefPlacementsContract = defineOp({
  kind: "plan",
  id: "ecology/features/aquatic-placement/cold-reef",
  input: Type.Object({
  ...
  output: Type.Object({
    placements: Type.Array(
      Type.Object({
        ...
        feature: Type.Literal("FEATURE_COLD_REEF"),
      })
    ),
  }),
  strategies: {
    default: Type.Object({
      multiplier: Type.Number({
        description: "Scalar multiplier applied to cold reef chance (0..2 typical).",
        default: 1,
        minimum: 0,
      }),
...
export default PlanAquaticColdReefPlacementsContract;
