...
const PlanVegetationEmbellishmentsForestDensityContract = defineOp({
  kind: "plan",
  id: "ecology/features/vegetation-embellishments/forest-density",
  input: Type.Object({
...
export default PlanVegetationEmbellishmentsForestDensityContract;
