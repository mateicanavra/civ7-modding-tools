...
const hotWetDenseStrategy = createStrategy(Contract, StrategyDefinition, {
  run: (input, config) => {
    ...
    const allowedBiomes = new Set<BiomeSymbol>(config.allowedBiomes);
...
export default hotWetDenseStrategy;
