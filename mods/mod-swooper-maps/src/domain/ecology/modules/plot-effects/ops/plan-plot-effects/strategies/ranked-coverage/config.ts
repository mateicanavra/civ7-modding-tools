  ...
  config: Type.Object(
    {
      snow: Type.Object(
        ...
        {
          description:
            "Controls snow plot-effect coverage, thresholds, and optional hazard intent.",
        }
      ),
      sand: Type.Object(
        {
    ...
    {
      description:
        "Ranked plot-effect coverage, intensity, and hazard controls for each admitted effect family.",
    }
  ),
});
