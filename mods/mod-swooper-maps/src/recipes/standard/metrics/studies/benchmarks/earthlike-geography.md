...
Geography must retain land share from `0.15` through `0.90`, lake share at or
below `0.20`, and at least one continental-shelf tile beyond shoreline-adjacent
water. Hydrology must contain river coverage and zero receiver-integrity
...
`shelf-beyond-shoreline`, `river-coverage`, `hydrology-receiver-integrity`,
`biome-diversity`, and `dominant-biome`.
