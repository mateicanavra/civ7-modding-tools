import { MORPHOLOGY_SHELF_WIDTH_MULTIPLIER } from "@mapgen/domain/morphology/modules/shelf/model/policy/shelf-knob-policy.js";
...
/**
 * Derives the final post-island shelf and coastline product from Morphology
...
export const ComputeShelfStep = createStep(config, {
  ...
  viz: ({ result: { bathymetry, landMask, shelf, evidence }, dimensions }) => [
    ...
    },
    {
      ...
      spaceId: TILE_SPACE_ID,
      dims: dimensions,
      field: { format: "u8", values: evidence.activeMarginMask },
      meta: defineStandardVizCategoryMeta(
    ...
    },
    {
      ...
      spaceId: TILE_SPACE_ID,
      dims: dimensions,
      field: { format: "i16", values: evidence.shelfBreakDepthByTile },
    ...
    },
    {
      ...
      spaceId: TILE_SPACE_ID,
      dims: dimensions,
      field: { format: "u8", values: evidence.nearshoreCandidateMask },
      meta: defineStandardVizCategoryMeta(
    ...
    },
    {
      ...
      spaceId: TILE_SPACE_ID,
      dims: dimensions,
      field: { format: "u8", values: evidence.depthGateMask },
      meta: defineStandardVizCategoryMeta(
