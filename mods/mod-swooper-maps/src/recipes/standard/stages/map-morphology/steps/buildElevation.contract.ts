...
const BuildElevationStepContract = defineStep({
  id: "build-elevation",
  phase: "gameplay",
  requires: [MAP_PROJECTION_EFFECT_TAGS.map.mountainsPlotted, MAP_PROJECTION_EFFECT_TAGS.map.volcanoesPlotted],
  provides: [MAP_PROJECTION_EFFECT_TAGS.map.elevationBuilt, MAP_PROJECTION_EFFECT_TAGS.map.morphologyParityCaptured],
  artifacts: {
