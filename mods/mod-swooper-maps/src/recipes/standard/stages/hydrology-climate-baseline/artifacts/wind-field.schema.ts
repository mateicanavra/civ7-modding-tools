...
/**
 * Combined wind + surface current field used by Hydrology climate-baseline artifacts.
 *
 * Winds and currents are distinct signals: currents are ocean-only coupling; winds are
 * atmosphere-wide forcing. Values are discrete `i8` components for compactness; consumers
 * should treat them as direction/intensity proxies.
 */
