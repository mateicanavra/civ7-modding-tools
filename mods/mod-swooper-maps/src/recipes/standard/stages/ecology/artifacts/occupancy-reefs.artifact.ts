...
/** Runtime contract for occupancy after reef intents have claimed their tiles. */
...
/** Canonical schema entrypoint for registering and validating post-reef occupancy. */
...
/**
 * Validates post-reef occupancy against its closed schema and, when map dimensions are
