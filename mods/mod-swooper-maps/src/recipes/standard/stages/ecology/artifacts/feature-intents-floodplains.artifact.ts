...
/** Closed row contract for one floodplain placement intent selected by Ecology. */
...
/** Returns combined schema and feature-intent-list issues for floodplain intent without throwing. */
