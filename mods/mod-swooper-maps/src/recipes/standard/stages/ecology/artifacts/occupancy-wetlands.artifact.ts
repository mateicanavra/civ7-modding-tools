...
/** Runtime contract for occupancy after wetland intents and before vegetation planning. */
...
/** Canonical schema entrypoint for registering and validating post-wetland occupancy. */
export const Schema = OccupancyArtifactSchema;

/**
 * Registers occupancy after wetland planning. Vegetation planning consumes this exact
 * snapshot, making family ordering deterministic and preventing a tile from being claimed
 * twice.
 */
...
/**
 * Validates post-wetland occupancy against its closed schema and, when map dimensions are
