    ...
    const platesResult = ops.computePlates(
      {
        ...
        crust: {
          type: crust.type,
          maturity: crust.maturity,
          thickness: crust.thickness,
          damage: crust.damage,
          age: crust.age,
          buoyancy: crust.buoyancy,
          baseElevation: crust.baseElevation,
          strength: crust.strength,
        },
        plateGraph: {
        ...
        tectonicHistory: {
          ...
          eras: tectonicHistory.eras,
          upliftTotal: tectonicHistory.upliftTotal,
          collisionTotal: tectonicHistory.collisionTotal,
          subductionTotal: tectonicHistory.subductionTotal,
          fractureTotal: tectonicHistory.fractureTotal,
          volcanismTotal: tectonicHistory.volcanismTotal,
          upliftRecentFraction: tectonicHistory.upliftRecentFraction,
          collisionRecentFraction: tectonicHistory.collisionRecentFraction,
          subductionRecentFraction: tectonicHistory.subductionRecentFraction,
          lastActiveEra: tectonicHistory.lastActiveEra,
          lastCollisionEra: tectonicHistory.lastCollisionEra,
          lastSubductionEra: tectonicHistory.lastSubductionEra,
        },
        tectonicProvenance: {
          provenance: {
            originEra: tectonicProvenance.provenance.originEra,
            originPlateId: tectonicProvenance.provenance.originPlateId,
            lastBoundaryEra: tectonicProvenance.provenance.lastBoundaryEra,
            lastBoundaryType: tectonicProvenance.provenance.lastBoundaryType,
          },
        },
      },
