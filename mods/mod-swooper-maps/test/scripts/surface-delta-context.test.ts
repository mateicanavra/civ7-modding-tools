...
describe("surface delta context diagnostics", () => {
  test("extracts feature/resource mismatch rows with symbols", () => {
    const local = snapshot({
      feature: { ...SYNTHETIC_DIMENSIONS, values: [11, -1, -1, 6, -1, -1] },
      resource: { ...SYNTHETIC_DIMENSIONS, values: [-1, 3, -1, -1, -1, -1] },
    });
    const live = snapshot({
      feature: { ...SYNTHETIC_DIMENSIONS, values: [-1, -1, -1, 6, -1, -1] },
      resource: { ...SYNTHETIC_DIMENSIONS, values: [-1, -1, -1, -1, -1, -1] },
    });
  ...
  test("classifies coast/ocean terrain edge swaps with neighborhood context", () => {
    const local = snapshot(
      {
        terrain: { ...SYNTHETIC_DIMENSIONS, values: [3, 4, 3, 2, 3, 4] },
      },
      {
        terrainProjection: {
          coastlineMetrics: {
    ...
    const live = snapshot({
      terrain: { ...SYNTHETIC_DIMENSIONS, values: [3, 3, 3, 2, 3, 4] },
    });
  ...
  test("classifies feature deltas into reef absences and nearby natural-wonder offsets", () => {
    const local = snapshot(
      {
        feature: { ...SYNTHETIC_DIMENSIONS, values: [11, 35, -1, -1, -1, 36] },
      },
      {
        featureIntents: {
    ...
    const live = snapshot({
      feature: { ...SYNTHETIC_DIMENSIONS, values: [-1, -1, 35, -1, 36, -1] },
    });
  ...
  test("summarizes natural-wonder footprint readback direction matches", () => {
    const local = snapshot(
      {
        feature: { ...SYNTHETIC_DIMENSIONS, values: [-1, 35, 35, -1, -1, -1] },
      },
      {
        naturalWonderPlan: {
          ...SYNTHETIC_DIMENSIONS,
  ...
  test("classifies natural-wonder footprint direction divergence", () => {
    ...
    const live = snapshot({
      feature: { ...SYNTHETIC_DIMENSIONS, values: [-1, 35, -1, 35, -1, -1] },
    });
  ...
  test("joins exact-run readback evidence to natural-wonder catalog direction classes", () => {
    ...
    const local = snapshot(
      {
        feature: { ...SYNTHETIC_DIMENSIONS, values: [-1, 36, -1, -1, 36, -1] },
      },
      {
        naturalWonderPlan: {
          ...SYNTHETIC_DIMENSIONS,
    ...
    const live = snapshot({
      feature: { ...SYNTHETIC_DIMENSIONS, values: [-1, 36, -1, 36, -1, -1] },
    });
  ...
  test("checks static feature and resource surface legality against snapshot context", () => {
    ...
    const openCoast = snapshot({
      terrain: { ...SYNTHETIC_DIMENSIONS, values: [3, 3, 3, 3, 3, 3] },
      biome: { ...SYNTHETIC_DIMENSIONS, values: [5, 5, 5, 5, 5, 5] },
      feature: { ...SYNTHETIC_DIMENSIONS, values: [-1, -1, -1, -1, -1, -1] },
    });
  ...
  test("cross-checks local and live values against both surfaces", () => {
    ...
    const live = snapshot({
      terrain: { ...SYNTHETIC_DIMENSIONS, values: [3, 2, 2, 2, 2, 3] },
      biome: { ...SYNTHETIC_DIMENSIONS, values: [5, 1, 1, 1, 2, 5] },
      resource: { ...SYNTHETIC_DIMENSIONS, values: [-1, -1, -1, -1, -1, -1] },
    });
  ...
  test("joins resource deltas to local placement plan and assignment outcomes", () => {
    const local = snapshot(
      {
        resource: { ...SYNTHETIC_DIMENSIONS, values: [3, -1, 2, -1, -1, -1] },
      },
      {
        resourcePlan: {
          siteSpacingTiles: 2,
    ...
    const live = snapshot({
      resource: { ...SYNTHETIC_DIMENSIONS, values: [-1, 3, 12, -1, -1, -1] },
    });
