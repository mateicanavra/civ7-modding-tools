...
const SYNTHETIC_PARITY_CARDINALITY =
  SYNTHETIC_PARITY_DIMENSIONS.width * SYNTHETIC_PARITY_DIMENSIONS.height;
const SYNTHETIC_MISMATCHED_RIVER_DIMENSIONS = { width: 3, height: 1 } as const;
...
function snapshot(args: {
  ...
  const { width, height } = SYNTHETIC_PARITY_DIMENSIONS;
  const localEvidence = {
...
describe("final-surface parity evidence", () => {
  test("reports river metadata parity with planned minor and major masks separated", () => {
    const localRiverMetadata: FinalSurfaceSnapshot["riverMetadata"] = {
      ...SYNTHETIC_PARITY_DIMENSIONS,
      plannedMinorRiver: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [1, 0] },
      plannedMajorRiver: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [0, 1] },
      projectedNavigableTerrain: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [0, 1] },
    ...
    const liveRiverMetadata: FinalSurfaceSnapshot["riverMetadata"] = {
      ...SYNTHETIC_PARITY_DIMENSIONS,
      terrainNavigableRiver: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [0, 1] },
      riverType: {
        ...SYNTHETIC_PARITY_DIMENSIONS,
        values: [RIVER_TYPE_MINOR, RIVER_TYPE_NAVIGABLE],
      },
      river: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [1, 1] },
      navigableRiver: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [0, 1] },
      minorRiver: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [1, 0] },
    };
  ...
  test("fails metadata parity when native minor rivers do not match planned minor-river evidence", () => {
    const evidence = buildFinalSurfaceParityReport({
      exactAuthorship: exactEvidence(),
      local: snapshot({
        source: "local-mapgen",
        ...
        riverMetadata: {
          ...SYNTHETIC_PARITY_DIMENSIONS,
          plannedMinorRiver: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [1, 0] },
          plannedMajorRiver: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [0, 0] },
          projectedNavigableTerrain: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [0, 0] },
          minorRiverStampingSupported: true,
          minorRiverUnsupportedReason: nativeRiverMetadataReadbackReason,
        },
      }),
      live: snapshot({
        ...
        riverMetadata: {
          ...SYNTHETIC_PARITY_DIMENSIONS,
          terrainNavigableRiver: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [0, 0] },
          riverType: {
            ...SYNTHETIC_PARITY_DIMENSIONS,
            values: [NO_RIVER_TYPE, RIVER_TYPE_MINOR],
          },
          river: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [0, 1] },
          navigableRiver: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [0, 0] },
          minorRiver: { ...SYNTHETIC_PARITY_DIMENSIONS, values: [0, 1] },
        },
        nativeRiverObjects: nativeRiverObjects(1),
      }),
      now: () => new Date("2026-06-06T00:00:00.000Z"),
  ...
  test("blocks river metadata parity when local and live grids have different dimensions", () => {
    const liveRiverMetadata: FinalSurfaceSnapshot["riverMetadata"] = {
      ...SYNTHETIC_MISMATCHED_RIVER_DIMENSIONS,
      ...
      river: { ...SYNTHETIC_MISMATCHED_RIVER_DIMENSIONS, values: [0, 0, 0] },
      navigableRiver: {
        ...SYNTHETIC_MISMATCHED_RIVER_DIMENSIONS,
        values: [0, 0, 0],
      },
      minorRiver: { ...SYNTHETIC_MISMATCHED_RIVER_DIMENSIONS, values: [0, 0, 0] },
    };
