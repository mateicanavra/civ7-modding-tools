...
type HotspotEventsInput = Parameters<typeof computeHotspotEvents.run>[0];
type PlateMotionInput = Parameters<typeof computePlateMotion.run>[0];
...
type TectonicHistoryChainInput = Readonly<
  Omit<EraPlateMembershipInput, "mesh"> &
    Pick<Parameters<typeof computeTectonicSegments.run>[0], "crust"> & {
      mesh: EraPlateMembershipInput["mesh"] & Pick<PlateMotionInput["mesh"], "areas">;
      mantleForcing: PlateMotionInput["mantleForcing"] & HotspotEventsInput["mantleForcing"];
