    ...
    const landmask = computeLandmask.run(
      {
        ...
        upliftTotal: projection.tectonicHistoryTiles.rollups.upliftTotal,
        volcanismTotal: projection.tectonicHistoryTiles.rollups.volcanismTotal,
        upliftRecentFraction: projection.tectonicHistoryTiles.rollups.upliftRecentFraction,
        lastActiveEra: projection.tectonicHistoryTiles.rollups.lastActiveEra,
