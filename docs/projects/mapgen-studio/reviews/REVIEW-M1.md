...
- Status: `@mapgen/browser-recipes` was removed; Studio now imports recipe artifacts from `mod-swooper-maps/recipes/*`.
- Guidance: ensure studio recipe artifacts types are generated by `mods/mod-swooper-maps/scripts/generate-studio-recipe-types.ts`.
