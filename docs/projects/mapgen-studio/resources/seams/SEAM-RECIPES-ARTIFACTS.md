# Status: Superseded Seam Note

The early separate browser-recipe packaging seam has been retired. Studio consumes the active Standard recipe runtime and generated Standard recipe artifacts from `mod-swooper-maps`.
