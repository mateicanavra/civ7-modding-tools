...
Retire a niche rule only after a named generic or typed owner proves the same
invariant. The program ends only when generic laws, source tree, types, tests,
