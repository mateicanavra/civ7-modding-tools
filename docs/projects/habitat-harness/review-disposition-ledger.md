...
| F21 | R3 | H8 `bunx nx migrate @habitat/cli` resolves via npm registry; package is unpublished | ACCEPT | Mechanism specified: hand-authored `migrations.json` + `bunx nx migrate --run-migrations=migrations.json`; gate = no-op migration executes |
