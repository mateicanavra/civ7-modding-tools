...
- `bun run nx run @internal/habitat-harness:build && bun tools/habitat-harness/bin/run.js --help`
...
- `bun run nx run @internal/habitat-harness:generated:check --outputStyle=static`
