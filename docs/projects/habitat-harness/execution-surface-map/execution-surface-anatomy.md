...
| package-script | 190 | apps/cli/package.json: Workspace entrypoint that may invoke Habitat or package-local work.<br>apps/cli/package.json: Workspace entrypoint that may invoke Habitat or package-local work.<br>apps/cli/package.json: Workspace entrypoint that may invoke Habitat or package-local work. |
| nx-target | 124 | apps/cli/project.json: Workspace entrypoint that may invoke Habitat or package-local work.<br>apps/cli/project.json: Workspace entrypoint that may invoke Habitat or package-local work.<br>apps/cli/project.json: Workspace entrypoint that may invoke Habitat or package-local work. |
...
| habitat-cli-source | 120 | tools/habitat/src/cli/base/command-lifecycle.ts: Toolkit runner/provider code that executes or routes rule surfaces.<br>tools/habitat/src/cli/base/HabitatCommand.ts: Toolkit runner/provider code that executes or routes rule surfaces.<br>tools/habitat/src/cli/commands/check.ts: Toolkit runner/provider code that executes or routes rule surfaces. |
