...
| PH2-REV-002 | P1 | G-HOST/D10/D7/D9 ordering was contradictory: D10 appeared as an unblocker for D7/D9 while D7/D9 did not consistently block on D10. | Accepted and repaired. The authoritative DAG is now G-HOST -> D10 -> D7/D9 for generated/protected claims; only evidence investigation may happen before the blocker is satisfied. | `domain-refactor-prep/domino-candidate-ledger.md`; `README.md`; `D7-structural-enforcement-pipeline.md`; `D9-pattern-apply.md`; `D10-generated-protected-zones.md`; `G-HOST-host-policy-boundary-gate.md`. |
