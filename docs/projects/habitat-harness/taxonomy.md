...
| `kind:cli-topic-plugin` | `kind:plugin`, `kind:library` | topic packages adapt reusable capabilities into one oclif command surface without depending on the shell or another topic |
