...
- Current Habitat reference docs: `/Users/mateicanavra/Documents/.nosync/DEV/worktrees/wt-codex-habitat-toolkit-domain-refactor-frame/tools/habitat-harness/README.md`; `docs/SCENARIOS.md`; `docs/IMPLEMENTED-SURFACE.md`; `docs/DOMAIN-MAPPING.md`; `docs/CAPABILITIES.md`; `docs/GAPS.md`; `docs/AUTHORING-NEXT.md`.
