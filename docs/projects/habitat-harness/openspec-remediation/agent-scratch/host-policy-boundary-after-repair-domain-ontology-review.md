...
- Current source evidence only, including `tools/habitat/src/lib/generated-zones.ts`, `tools/habitat/src/lib/grit-apply.ts`, `tools/habitat/src/plugin.js`, `tools/habitat/src/rules/rules.json`, and `tools/habitat/src/generators/project/generator.cjs`.
