...
- D8 remains the owner of registration/admission semantics. The packet protects `.grit/patterns/habitat/checks/**`, `rules.json`, baselines, and `pattern-authority/manifest.ts` except through D8-governed paths.
