...
| --- | --- | --- | --- | --- | --- |
| D0 | D0 Command Surface Inventory | `deep-habitat-d0-command-surface-inventory` | Fresh worktree from main, dependency install, matrix validation, OpenSpec validation, D0 command/test probes | All later dominoes | implementation matrix authored at `docs/projects/habitat-harness/public-surface-compatibility-matrix.md` with 328 concrete rows; packet-boundary approved for D1 implementation-start preparation |
| D1 | D1 Receipt Contract Boundary | `deep-habitat-d1-receipt-contract-boundary` | D0 command surface inventory; concrete D0 matrix rows now exist; D1 execution inventory, output-family citations, inherited D0 evidence baseline, and implementation-start review dispositions required before source implementation | D6, D7, D8, D9, D10, D11, D12, D13, D14 | implementation-start preparation active; accepted for design/specification; final review and re-review found no unresolved P1/P2 blockers; not implementation-complete |
