...
are repaired. D0, D1, D2, D3, D4, D5, D6, D7, D8, D9, D10, D11, and D12 are the current exceptions: they are
accepted for design/specification after their per-domino final reviews found no
unresolved P1/P2 blockers. D0-D12 are not implementation-complete, and
D13-D15/G-HOST remain blocking unless their own status rows say otherwise.
