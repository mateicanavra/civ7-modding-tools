...
| D3 | D3 Workspace Graph Boundary | `deep-habitat-d3-workspace-graph-boundary` | D0, D2; concrete D0 public-surface rows and live D2 `ruleGraphFacts` implementation required before source implementation | D4, D7, D12 | source implementation in progress; implementation-start inventory cites concrete D0 rows and live D2 graph projection facts; not implementation-complete |
