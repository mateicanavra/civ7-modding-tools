...
| DL-12 | P3 | pre-H4: `.prettierrc` existed; no doc or gate mentioned formatting | Biome config present; CI/local harness wiring pending in H4 | Resolved by slice H4 (Biome); no decision needed |
