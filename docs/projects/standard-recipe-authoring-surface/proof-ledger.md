...
| Stable compiled-config equivalence | `mods/mod-swooper-maps/test/fixtures/legacy-ecology-compiled.json`; `maps-schema-valid.test.ts` stable comparison | Checked-in golden fixture was generated before Ecology migration by compiling shipped Ecology configs with `seed=123`, `dimensions=80x60`, and `latitudeBounds=60/-60`; after morphology peer-review replay, the fixture carries only the accepted Swooper Earthlike reef/rainforest threshold deltas while preserving the rest of the stable Ecology comparison. |
| Generated artifact regeneration | `bun run build:studio-recipes` in `mods/mod-swooper-maps` | Regenerated standard recipe/browser recipe dist outputs, Studio recipe type artifacts, and four generated source map artifacts from migrated source configs. |
...
| Generated recipe artifact guards | `bun run --cwd mods/mod-swooper-maps build:studio-recipes`; `bun test mods/mod-swooper-maps/test/config/standard-recipe-artifact-guards.test.ts` | Passed 1 test / 5 expects. Generated standard schema and UI metadata match source recipe stages, generated default config matches normalized `swooper-earthlike.config.json`, and generated defaults contain no raw envelopes. |
| Studio artifact guards | `bun run --cwd apps/mapgen-studio test -- standardRecipeArtifactGuards` | Passed 3 tests. Catalog/runtime entries share the same generated artifacts, UI focus paths land on public schema/default paths, and built-in presets validate without raw envelopes. |
| Shipped config, preset, Studio, and guard suite | `bun test mods/mod-swooper-maps/test/config/maps-schema-valid.test.ts mods/mod-swooper-maps/test/config/presets-schema-valid.test.ts mods/mod-swooper-maps/test/config/studio-presets-schema-valid.test.ts mods/mod-swooper-maps/test/config/shipped-map-identity.test.ts mods/mod-swooper-maps/test/config/standard-authoring-surface-guards.test.ts mods/mod-swooper-maps/test/config/standard-recipe-artifact-guards.test.ts apps/mapgen-studio/test/config/defaultConfigSchema.test.ts apps/mapgen-studio/test/config/standardRecipeArtifactGuards.test.ts` | Focused suite covers shipped configs, generated recipe artifacts, Studio catalog/runtime artifacts, public focus paths, and raw-envelope regressions. |
