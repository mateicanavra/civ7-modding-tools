...
+<!-- SECTION SCOPE [SYNC] -->
+## TL;DR
+- Implement required interactions for tuning (era scrubber, toggles, correlation overlays).
+
+## Deliverables
+- Implement required interactions for tuning (era scrubber, toggles, correlation overlays).
- Keep visualization distinct from validation; no correctness logic in viewer.
+
+## Acceptance Criteria
