...
- [x] [`LOCAL-TBD-PR-M1-004`](../issues/LOCAL-TBD-PR-M1-004-add-validation-harness-scaffolding-determinism-fingerprints-.md) Add validation harness scaffolding (determinism fingerprints + invariant runners) — branch: `agent-URSULA-M1-LOCAL-TBD-PR-M1-004-validation-harness-scaffolding`; PR: https://app.graphite.com/github/pr/mateicanavra/civ7-modding-tools/1076
