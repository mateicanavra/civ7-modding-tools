...
- [x] [`LOCAL-TBD-PR-M1-002`](../issues/LOCAL-TBD-PR-M1-002-add-tile-projections-for-tectonic-history-provenance-mandato.md) Add tile projections for tectonic history + provenance (mandatory drivers) — branch: `agent-URSULA-M1-LOCAL-TBD-PR-M1-002-project-tectonic-history-provenance-tiles`; PR: https://app.graphite.com/github/pr/mateicanavra/civ7-modding-tools/1074
