...
- [ ] [`LOCAL-TBD-PR-M1-011`](../issues/LOCAL-TBD-PR-M1-011-event-engine-subduction-collision-rift-transform-mandatory-f.md) Event engine: subduction/collision/rift/transform + mandatory force emission (D06r)
...
| [`LOCAL-TBD-PR-M1-010`](../issues/LOCAL-TBD-PR-M1-010-boundary-segments-regime-classification-source-of-events.md) | Make boundary segments + regime classification the authoritative “where events happen” surface used by history + event engine (no duplicated boundary inference). |; review: `agent-BURAKA-LOCAL-TBD-PR-M1-010-review-boundary-segments-regime-classification-source-of-events` (PR: pending)
...
| D06r events + force emission | `LOCAL-TBD-PR-M1-010`, `LOCAL-TBD-PR-M1-011` |; review: `agent-BURAKA-LOCAL-TBD-PR-M1-010-review-boundary-segments-regime-classification-source-of-events` (PR: pending)
