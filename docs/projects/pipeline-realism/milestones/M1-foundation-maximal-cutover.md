...
>>>>>>> e7d308acd (docs(pipeline-realism): update PR-M1-009 link)
...
| [`LOCAL-TBD-PR-M1-007`](../issues/LOCAL-TBD-PR-M1-007-mantle-potential-generation-derived-forcing-fields-d02r.md) | Introduce mantle potential as a truth artifact and derive forcing fields (D02r) that will drive plate motion and event mechanics with bounded budgets. |; review: `agent-BURAKA-LOCAL-TBD-PR-M1-007-review-mantle-potential-generation-derived-forcing-fields-d02r` (PR: pending)
| [`LOCAL-TBD-PR-M1-008`](../issues/LOCAL-TBD-PR-M1-008-plate-motion-solver-derived-from-mantle-forcing-d03r.md) | Implement plate motion as a derived solution from mantle forcing (D03r), with coupling invariants that prevent “authoring kinematics by accident.” |; review: `agent-BURAKA-LOCAL-TBD-PR-M1-008-review-plate-motion-solver-derived-from-mantle-forcing-d03r` (PR: pending)
...
| D02r mantle forcing as potential + derived | `LOCAL-TBD-PR-M1-007` |; review: `agent-BURAKA-LOCAL-TBD-PR-M1-007-review-mantle-potential-generation-derived-forcing-fields-d02r` (PR: pending)
| D03r plate motion derived from mantle | `LOCAL-TBD-PR-M1-008` |; review: `agent-BURAKA-LOCAL-TBD-PR-M1-008-review-plate-motion-solver-derived-from-mantle-forcing-d03r` (PR: pending)
