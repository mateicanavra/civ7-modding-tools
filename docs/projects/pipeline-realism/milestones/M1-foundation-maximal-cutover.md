...
- [x] [`LOCAL-TBD-PR-M1-009`](../issues/LOCAL-TBD-PR-M1-009-crust-priors-resistance-partition-plategraph-d01.md) Crust priors + resistance partition -> plateGraph (D01) — branch: `agent-URSULA-M1-LOCAL-TBD-PR-M1-009-crust-priors-resistance-partition-plategraph-d01`; PR: https://app.graphite.dev/submit/mateicanavra/civ7-modding-tools/1081
