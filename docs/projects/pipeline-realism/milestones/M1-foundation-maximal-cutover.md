...
- [x] [`LOCAL-TBD-PR-M1-006`](../issues/LOCAL-TBD-PR-M1-006-basaltic-lid-init-lithosphere-strength-mantle-coupled.md) Basaltic lid init + lithosphere strength (mantle-coupled) — branch: `agent-URSULA-M1-LOCAL-TBD-PR-M1-006-basaltic-lid-init-lithosphere-strength-mantle-coupled`; PR: https://app.graphite.com/github/pr/mateicanavra/civ7-modding-tools/1078
