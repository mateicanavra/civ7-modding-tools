...
- Branch: `codex/MAMBO-m3-005-plan-reefs-deterministic` (parent: `codex/MAMBO-m3-004-plan-ice-deterministic`; base: `main`)
- Draft PRs: M3-002 `#1223`, M3-003 `#1224`, M3-004 `#1225`
...
- Current issue: `docs/projects/pipeline-realism/issues/LOCAL-TBD-PR-M3-005-deterministic-planning-reefs-add-missing-reef-family-features.md`
