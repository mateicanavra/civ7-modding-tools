...
- Code: `mods/mod-swooper-maps/src/domain/foundation/lib/require.ts` (history/provenance validation); `mods/mod-swooper-maps/src/recipes/standard/stages/morphology-coasts/steps/landmassPlates.contract.ts` (current upstream deps); `mods/mod-swooper-maps/src/domain/foundation/ops/compute-era-tectonic-fields/contract.ts` (era fields); `mods/mod-swooper-maps/src/domain/foundation/ops/compute-tectonic-history-rollups/contract.ts` (rollups); `mods/mod-swooper-maps/src/domain/foundation/ops/compute-tectonic-provenance/contract.ts` (provenance); `mods/mod-swooper-maps/src/domain/foundation/ops/compute-tectonic-segments/contract.ts` (segment inputs for belt continuity)
...
- Foundation history/provenance validation now allows 5..8 eras; Morphology still needs an explicit era-selection/blending contract.
