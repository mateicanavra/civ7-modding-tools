...
as `game play front scan`, `game play destination-analysis`, and
`game play front target-candidates` should give the runner wider lenses over
fronts, endpoints, corridors, pressure, points of interest, and target owners
while leaving strategy selection, movement, and combat sends to explicit
