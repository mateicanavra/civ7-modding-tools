...
| Promotion args and readiness | `.civ7/outputs/resources/Base/modules/base-standard/ui/unit-promotion/panel-unit-promotion.js:693`; `model-unit-promotion.chunk.js:146` | promotion spend decisions | keep `promotion-readiness`; add proof-bounded `promote-unit` with returned args | high for reads, medium for spend | promotion spend is irreversible |
