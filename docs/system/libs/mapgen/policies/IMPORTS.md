...
- Recipe import guard: Habitat `grit-recipe-domain-surface` and
  ...
  `.habitat/civ7/mapgen/blueprints/domain-model/boundary/check/recipe-domain-surface/recipe-domain-surface.rule.json` and
  `.habitat/civ7/mapgen/blueprints/domain-model/boundary/check/domain-deep-import/domain-deep-import.rule.json`
