...
This page is a curated, machine-first index into the canonical MapGen doc spine.
It’s meant for AI agents and tooling that need stable pointers to “the one right doc” for a concept.
...
- Treat engine-refactor-v1 specs/ADRs as target authority, and code as current reality.
- Do not guess APIs or contracts; anchor every contract claim to code/spec paths and named symbols.
