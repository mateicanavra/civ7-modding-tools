...
- Foundation projection step (tile projections + viz emissions): `plugins/mod/map/swooper-physics/src/recipes/standard/stages/foundation/projection/steps/projection/step.ts`
- Standard recipe water-surface parity guard: `plugins/mod/map/swooper-physics/src/recipes/standard/water-surface-parity.ts`
