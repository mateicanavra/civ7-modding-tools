...
Reference pages define contracts precisely (APIs, schemas, invariants, and key vocabulary).

## Audience

- Developers implementing or reviewing SDK/pipeline changes.
- Tooling and documentation authors.
- AI agents extracting canonical contracts.
