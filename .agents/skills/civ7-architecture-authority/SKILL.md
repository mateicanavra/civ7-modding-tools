...
<invariant name="core-stays-pure">`packages/mapgen-core` owns pure MapGen domain, recipe, config, artifact, compiler, and execution logic. It must not import Civ7 engine globals or game runtime APIs directly.</invariant>
